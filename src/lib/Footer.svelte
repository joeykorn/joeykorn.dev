...
<footer class="items-center mt-32 px-4 md:px-20">
	<div class="flex space-x-3 items-center">
		<p class="text-neutral-800 dark:text-neutral-300 text-xs py-3.5">&copy; {dateYear} Joey Korn</p>
		<div class="h-3 w-px bg-neutral-800 dark:bg-neutral-400"></div>
		<a
			class="text-neutral-800 dark:text-neutral-300 text-xs dark:decoration-orange-700 hover:underline underline-offset-2 flex items-center gap-2 py-3.5"
			href="https://github.com/joeykorn"
			target="_blank"
